<?php
  ...
  class StoreConfigReceiptController
  {
      public function viewStoreConfigReceipt($request , $response)
      {
        $db = pdo();
        $selectStoreConfig = $db->select()->from('store_config_receipt');
     ...
     if($data != null){
      ...
      public function updateStoreConfigReceipt($request , $response)
      {
